                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="#collapse-shipping" class="accordion-toggle"
                                                           data-toggle="collapse" data-parent="#accordion">Estimate
                                        Shipping &amp; Taxes <i class="fa fa-caret-down"></i></a></h4>
                            </div>
               ...
               class="btn btn-primary"/>
                    ...
                    <div class="col-sm-4 sub-total-table">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right total-amount">$4.00</td>
                            </tr>
                            <tr>
                                <td class="text-right"><strong>VAT (20%):</strong></td>
                                <td class="text-right total-amount">$40.00</td>
                            </tr>
                            <tr>
                                <td class="text-right"><strong>Total:</strong></td>
                                <td class="text-right total-amount">$244.00</td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="buttons clearfix">
                    <div class="pull-left"><a
                            href="https://demo.ishithemes.com/opencart/OPC140/OPC140L01/index.php?route=common/home"
                            class="btn btn-default">Continue Shopping</a></div>
                    <div class="pull-right"><a
                            href="https://demo.ishithemes.com/opencart/OPC140/OPC140L01/index.php?route=checkout/checkout"
