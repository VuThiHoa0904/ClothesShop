...
{{--    <div class="container">--}}
{{--        <div class="row">--}}
{{--            <div id="adress" class="col-3"><ion-icon name="home-outline"></ion-icon> : {!!getSetting('address')!!}</div>--}}
{{--            <div id="phone" class="col-3"><ion-icon name="call-outline"></ion-icon> : {!!getSetting('phone')!!}</div>--}}
{{--            --}}
{{--            <div class="col-6">--}}
                            ...
                            <a title="Account" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <div class="user-logo hidden-lg hidden-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                        <symbol id="user-desktop" viewBox="0 0 480 480"><title>
                                                user-desktop</title>
